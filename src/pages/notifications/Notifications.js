...
class Notifications extends React.Component {
    ...
    displayNotifications = (notifications)=>{
        if(notifications.length<1){
            ...
            return(
                <Notif DATA={notifications}  SHOW_CONVERSATION_MANAGER_MODAL={this.handleShowingConversationModal}/>
            )
        }
    }
