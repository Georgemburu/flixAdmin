...
import Notif from '../../components/dumb/notif'
import MovieOrder from '../../modals/movie_order/MovieOrder'
...
class History extends React.Component {
        ...
        return(
            <Fragment>
                { dates.map((date,index)=>{
                    return(
                        <div className="History" key={'history'+index}>
                            <div className="history_title canClick hoverFade"> { date } </div>
                            <div className="history_data">
                                <Notif DATA={history[date]}  SHOW_CONVERSATION_MANAGER_MODAL={this.handleShowingConversationModal}/>
                            </div>
                        </div>
                    )
                })}
    ...
    render(){
        let { history , show_conversation_modal} = this.state;
        return (
            <Fragment>
                <MovieOrder SHOW={show_conversation_modal} CLOSEMODAL_FUNC_PROP={this.CLOSEMODAL_FUNC} />
                <Manager TITLE="History">
